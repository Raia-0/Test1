    ...
    <div className="w-full h-20 bg-[#F5E7C6] shadow-[inset_0_-4px_0_0_#EF820D]">
      <div className="px-5 w-full h-full m-auto flex justify-between items-center gap-10">
        ...
        <div className="hidden lg:flex flex-grow gap-10">
          <Link className="px-5 py-full rounded-none flex justify-center items-center transition-all duration-100 font-['Montserrat'] hover:cursor-pointer hover:shadow-[inset_0_-4px_0_0_#9D2525]" to="/Dash">
          ...
          >
            <Link
              ...
              className=""
            >
              <Secondbutton text="Gráficos" type="button" />
            </Link>
