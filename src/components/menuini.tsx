...
export default function menuini() {
        ...
        <div className="w-full h-20 bg-[#F5E7C6] shadow-[inset_0_-4px_0_0_#EF820D]">
            ...
            {exibirMenu1 && (
                <div className="bg-[#F5E7C6] w-full h-[100vh-80px] fixed top-20 lg:hidden">
                    ...
                    <Link className="px-5 py-full rounded-none flex justify-center items-center transition-all duration-100 font-['Montserrat'] hover:cursor-pointer " to="/">
                    <Primarybutton
                        text="Início"
                        type="button"
                    />
