...
export default function menucontato() {
        ...
        <div className="w-full h-20 bg-[#F5E7C6] shadow-[inset_0_-4px_0_0_#EF820D]">
            <div className="px-5 w-full h-full m-auto flex justify-between items-center gap-10">
                ...
                <div className="hidden lg:flex flex-grow gap-10">
                    ...
                    <Link to="/Contact" className="px-5 py-full rounded-none flex justify-center items-center transition-all duration-100 font-['Montserrat'] hover:cursor-pointer " >
                        <Primarybutton
                            text="Contato"
                            type="button"
                        />
