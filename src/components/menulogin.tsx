        ...
        <div className="w-full h-20 bg-[#F5E7C6] shadow-[inset_0_-4px_0_0_#EF820D]">
            <div className="px-5 w-full h-full m-auto flex justify-between items-center gap-10">
                ...
                <div className="hidden lg:flex flex-grow gap-10">
                    ...
                    <Link to="/" className="px-5 py-6 rounded-none flex justify-center items-center transition-all duration-100 font-['Montserrat'] hover:cursor-pointer hover:shadow-[inset_0_-4px_0_0_#9D2525] ">
                ...
                <div className="hidden lg:flex items-center gap-9" >
                    ...
                    <Link to="/Login" className="bg-[#F5E7C6] text-[#9D2525] text-2xl px-5 py-5 shadow-[inset_0_-4px_0_0_#9D2525] rounded-none justify-center items-center font-['Montserrat']"
                    >
            ...
            {exibirMenu1 && (
                <div className="bg-[#F5E7C6] w-full h-[100vh-80px] fixed top-20 lg:hidden">
                    ...
                    />
                        ...
                        <Link to="/Login" className="text-[#9D2525] px-5 py-full rounded-none flex justify-center items-center transition-all duration-100 font-['Montserrat'] hover:cursor-pointer shadow-[inset_0_-4px_0_0_#9D2525] "
                    >
